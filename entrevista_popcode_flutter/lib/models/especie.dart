class ColecaoEspecies {
  int count;
  String next;
  Null previous;
  List<Especie> results;

  ColecaoEspecies({this.count, this.next, this.previous, this.results});

  ColecaoEspecies.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
    previous = json['previous'];
    if (json['results'] != null) {
      results = new List<Especie>();
      json['results'].forEach((v) {
        results.add(new Especie.fromJson(v));
      });
    }
  }
